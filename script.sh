...
echo $secretVal
echo TODO 'https://docs.cyberark.com/conjur-enterprise/latest/en/content/integrations/k8s-ocp/k8s-jwt-authn.htm?tocpath=Integrations%7COpenShift%252FKubernetes%7CAuthenticate%20OpenShift%252FKubernetes%7C_____2'
echo TODO 'https://docs.cyberark.com/conjur-enterprise/latest/en/content/deployment/dap/dap-followers-lp.htm'
echo TODO 'https://docs.cyberark.com/conjur-enterprise/latest/en/content/integrations/k8s-ocp/k8s-conjfollower.htm'
